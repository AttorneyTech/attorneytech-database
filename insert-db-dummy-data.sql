...
VALUES
    ('林青竹與劉紀雯間臺北市羅斯福路房地拆屋還地事件', 103, 273),
    ('吳啟方與張佩君間車禍侵權行為損害賠償事件', 116, 304),
    ('陳俊文與臺北市政府間萬華區土地確認公用地役關係不存在事件', 129, 335),
    ('黃至山被訴違反證券交易法事件', 142, 366);
...
VALUES
    ('民事', '111', '訴', '1101', '拆屋還地', 1013, 653, 470, 103, 155, 273, 319),
    ('民事', '109', '訴', '1231', '侵權行為損害賠償', 1060, 674, 501, 116, 155, 304, 337),
    ('民事', '110', '上易', '12', '侵權行為損害賠償', 1060, 737, 594, 116, 155, 304, 337),
    ('行政', '110', '訴', '379', '巷道爭議', 1107, 716, 563, 129, 155, 335, NULL),
    ('刑事', '111', '金重訴', '38', '證券交易法等', 1154, 695, 532, 142, 155, 366, NULL);
