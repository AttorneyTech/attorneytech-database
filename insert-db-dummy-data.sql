...
INSERT INTO cases (
    case_closed, category, year, type, number, cause_of_action, event_id, section_in_charge_id,
    court_id, client_id, agent_id, opposite_client_id, opposite_agent_id
)
VALUES
    (FALSE, '民事', 111, '訴', '1101', '拆屋還地', 1013, 653, 470, 103, 155, 273, 319),
    (FALSE, '民事', 109, '訴', '1231', '侵權行為損害賠償', 1060, 674, 501, 116, 155, 304, 337),
    (FALSE, '民事', 110, '上易', '12', '侵權行為損害賠償', 1060, 737, 594, 116, 155, 304, 337),
    (FALSE, '行政', 110, '訴', '379', '巷道爭議', 1107, 716, 563, 129, 155, 335, NULL),
    (FALSE, '刑事', 111, '金重訴', '38', '證券交易法等', 1154, 695, 532, 142, 155, 366, NULL);
